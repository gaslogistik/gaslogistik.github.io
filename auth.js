...
async function submitAuth() {
  ...
  const account = users.find(u =>
    ...
    String(u.PASS) === pass &&
    String(u.ACTIVE).trim().toUpperCase() === "YES"
  );

  if (account) {

    localStorage.setItem("kp_logged", "1");
    localStorage.setItem("kp_user", user.toUpperCase());
...
const GAS_URL="https://script.google.com/macros/s/AKfycbxtEH-uWkS7-RTZYejYQLJZstOY67_z7N5xE8ktQObUj_2UmpJ-9w04kv7BVjgCpGXzSA/exec";
